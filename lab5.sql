...
INSERT INTO employees VALUES (1 , 'Max' , 'Norman' , 25 , 50000);
INSERT INTO employees VALUES ( 2, 'Jennie' , 'Smith' , 21 , 70000);
...
INSERT INTO customers VALUES (1, 'max@email.com', '123-456-7890', '2024-01-01');
INSERT INTO customers VALUES (2, 'jennies@email.com', NULL, '2024-01-02');
...
--4.3
--1
--PRIMARY KEY makes sure each row is unique and not empty (NOT NULL). Each table can have only one primary key.
--UNIQUE makes sure values are unique but can have NULLs (empty values). A table can have many unique constraints.
--2
--Single-column PRIMARY KEY one column identifies each row (e.g., dept_id).
--Composite PRIMARY KEY two or more columns together identify each row (e.g., student_id + course_id).
--3 Difference:
--The PRIMARY KEY is the main ID of a table and is often used in other tables as a foreign key.
--UNIQUE can also stop duplicate values, but the table can have several of them.
...
INSERT INTO employees_dept VALUES (101, 'John Smith', 10, '2023-01-15');
INSERT INTO employees_dept VALUES (102, 'Maria Garcia', 20, '2023-02-20');
